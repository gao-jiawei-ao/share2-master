...
public class MyLikeFragment extends BaseFragment {
    ...
    public static com.example.myapplication3.fragments.MyLikeFragment newInstance() {
        com.example.myapplication3.fragments.MyLikeFragment fragment = new com.example.myapplication3.fragments.MyLikeFragment();
        return fragment;
    }
...
//            refreshLayout=mRootView.findViewById(R.id.refreshLayout);
    ...
    private void getNewsList(final boolean isRefresh) {
        String url = "http://47.107.52.7:88/member/photo/like?userId=" + id;
